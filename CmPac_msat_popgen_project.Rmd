...
geno.data.start<-1 #make this number match the last column before genotype data
#read in data ####
...
Msat.Cm.geno.a<-Msat.Cm.geno[!(numNAs>((ncol(Msat.Cm.geno)-geno.data.start))*0.75),]
#no samples removed so can use original df
```
...
Msat.g <- df2gtypes(Msat.Cm.geno, ploidy = 2, id.col=1, loc.col=2,schemes = strata.schemes)
