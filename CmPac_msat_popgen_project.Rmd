...
Msat.Cm.geno.a<-Msat.Cm.geno[!(numNAs>((ncol(Msat.Cm.geno)-1))*0.75),]#this currently accounts for one column of labIDs in geno file, may ned to adjust formula if have additional columns for strata, etc.
```
...
table(Msat.Cm.strata$Broad) #N.B. CNMI only has 3 samples for now
#table(Msat.Cm.strata$Fine)
...
Msat.g <- new("gtypes", gen.data = Msat.Cm.geno[, -1], ploidy = 2,
                     ind.names = Msat.Cm.geno[, 1], schemes = strata.schemes, strata="Fine")
