...
Msat.Cm.geno.a<-Msat.Cm.geno[!(numNAs>((ncol(Msat.Cm.geno)-geno.data.start))*0.25),]
...
AF1<-alleleFreqs(Msat.g, by.strata = TRUE)


# to look at one-I need to come back and fix code to write to file by locus
write.csv(AF1$D2, file = paste(description, "_D2_alleleFreq.csv", sep = ""))#example-can do one by one but I will put the loci names in a list and loop them
